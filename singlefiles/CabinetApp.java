...
class Cabinet {
    ...
    public void putOn(String shelfName, Item item)
            throws NoSuchShelfException, NullShelfNameException, NullItemException {
        checkIfNotNullShelfName(shelfName);
        Shelf shelf = getShelfObjectByName(shelfName);
        if (item == null) {
        ...
        shelf.put(item);
        System.out.println(
                "You put " + item + " (" + item.getClass().getSimpleName() + ")" + " on " + shelfName.toLowerCase());
    }
    ...
    public Item takeThingFrom(String shelfName) throws NoSuchShelfException, NullShelfNameException {
        ...
        System.out.println(
                "You've taken " + takenItem + " (" + takenItem.getClass().getSimpleName() + ")" + " from " + shelf);
        return takenItem;
    }
